...
// ============================================================================
// File Name   : cache_flush.sv
// Module Name : cache_flush
// Description : Cache Flush and Initialization Controller.
//               Exact line-by-line conversion from open-source GPGPU cache flush.
// ============================================================================

`include "cache_define.vh"

module cache_flush import cache_pkg::*; #(
    parameter BANK_ID    = 0,
