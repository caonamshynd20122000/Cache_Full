...
// ============================================================================
// File Name   : cache_amo.sv
// Module Name : cache_amo
// Description : Per-Bank Atomic Memory Operation (AMO) Engine.
//               Handles Read-Modify-Write (RMW) operations, LR/SC reservations,
//               and passthrough result replays for GPGPU caches.
// ============================================================================

`include "cache_define.vh"

module cache_amo import gpu_pkg::*; #(
    parameter IS_LLC          = 0,
