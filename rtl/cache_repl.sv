...
// ============================================================================
// File Name   : cache_repl.sv
// Module Name : cache_repl (includes plru_decoder, plru_encoder, cache_repl)
// Description : Fast Tree-based PLRU, FIFO, and Random Cache Replacement System.
// ============================================================================

`include "cache_define.vh"

// Fast PLRU decoder utility
module plru_decoder import cache_pkg::*; #(
...
module cache_repl #(
    ...
    if (NUM_WAYS > 1) begin : g_enable
        if (REPL_POLICY == `CS_REPL_PLRU) begin : g_plru
            ...
            // Look-ahead read advances every non-stalled cycle
            dp_ram #(
                .DATAW (LRU_WIDTH),
            ...
            // Maximal-period LFSR over STATE_W bits
